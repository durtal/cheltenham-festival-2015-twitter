...
racecounts$race <- c("Triumph Hurdle", "Albert Bartlett", "Gold Cup")
...
The two plots below shows the number of tweets that mention a runner from each Championship race, and the most mentioned horses.  The most tweeted about race on Day Four was the Gold Cup, with `r racecounts$count[which(racecounts$race == "Gold Cup")]`.
